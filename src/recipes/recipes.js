...
const recipes: recipe[] = [
  ...
  },
  {
    ...
    instructions:
      "In a sauce pan on Medium heat add water and butter. Allow the butter to completely melt (about 2 minutes). Add Basil, Cayenne Pepper, Salt, Pepper, Paprika and Garlic Powder. Cook on Medium heat for about 2-3 minutes stirring slowly so that the butter is infused with the flavors. Lower the heat to Low.\r\n\r\nAdd Shrimp and stir slowly until shrimp turns a nice coral color and the tails curl. \r\n\r\n(3 Minutes with Extra Large Shrimp max 4-5 Minutes)\r\n\r\nBe careful not to over cook the shrimp or it will become rubbery. ",
    servings: 2,
    ingredients: [
      {
        display_index: 0,
  ...
  },
  {
    ...
    instructions:
      "Brush fish lightly with oil. In bowl combine remaining ingredients.  Place salmon on well-oiled, hinged grill. Baste salmon with lemon butter mixture & cook 5 minutes, then turn & continue cooking 5 minutes. Baste with lemon butter several times during cooking.",
    servings: 8,
    ingredients: [
      {
        display_index: 0,
